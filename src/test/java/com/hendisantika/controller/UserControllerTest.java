...
public class UserControllerTest {
    ...
    public void setup() {
        List<String> statements = Arrays.asList("DROP TABLE IF EXISTS \"users\" ;",
                "CREATE TABLE \"users\" ( id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name VARCHAR(100) " +
                        "NOT NULL, age integer,salary decimal);");
    ...
    private void setUpStreamingData(){
        ...
        mongoOperations.createCollection(UserCapped.class, CollectionOptions.empty().maxDocuments(20).size(50000)
        .capped());
